                ...
                <div id="main">
                    ...
                    <section id="one">
                        <header className="major">
                            <h2>Todo: Insert Title Here</h2>
                        </header>
                        <p>HI I’M KIKO I was born somewhere, and then grew up. Along the way I went to a prestigious college where I learned about important things. Like student loans. Then I lived in different cities and worked for different famous and important people. Then I ended up where I am now. And this is where I do stuff. I’ve won a bunch of important and/or impressive awards for some of that stuff. I hope to continue doing stuff for sometime now</p>
                    ...
                    <section id="three">
                        <h2>Get In Touch</h2>
                        <p>If you'd like to discuss rates or my availability, then feel free to shoot me a message below!</p>
                        <div className="row">
                            ...
                            <div className="4u 12u$(small)">
                                <ul className="labeled-icons">
                                    <li>
                                        ...
                                        3622 Virginia Street<br />
                                        Los Angeles, CA 90262<br />
                                        United States
                                    </li>
                                    <li>
